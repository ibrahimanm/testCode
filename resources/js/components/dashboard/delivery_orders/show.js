...
Vue.component('delivery-orders-show', {
    ...
    methods: {
        async fetchComments({ page, filter, sort }) {
            const response = await axios.get('/dashboard/delivery_orders/getComments/'+this.order.id, {params: { page, filter, sort }});
            this.loading = false;
            return {
        ...
        async fetchComplaints({ page, filter, sort }) {
            const response = await axios.get('/dashboard/delivery_orders/getComplaints/'+this.order.id, {params: { page, filter, sort }});
            this.loading = false;
            return {
                data: response.data.orders.data,
                pagination: {
