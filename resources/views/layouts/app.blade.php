...
<head>
    ...
    <style>
        ...
        * {
        ...
        h1, h2, h3, h4, h5, h6 {
            font-family: 'Droid Arabic Naskh', 'tahoma', serif !important;
        }
...
<!-- begin::Body -->
<body class="m-page--wide m-header--fixed m-header--fixed-mobile">

<!-- begin:: Page -->
<div class="m-grid m-grid--hor m-grid--root m-page" id="app" v-cloak>
                        ...
                        <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a  href="{{url('/')}}" class="m-brand__logo-wrapper">
                                    <img alt="" style="max-width: 231px;" src="{{ asset('img/logo.png') }}"/>
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="m-topbar__nav m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                        ...
                                        <a href="javascript:;" class="m-nav__link m-dropdown__toggle">
                                            <span class="m-topbar__username">{{ auth()->user()->name_ar }}</span>
                                            <span class="m-topbar__userpic">
														<img src="{{ auth()->user()->profile_img ? url('storage/'.auth()->user()->profile_img) :
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            <div class="m-content">
                <div class="row justify-content-center">
                    <div class="col-md-12" v-loading="loading" v-cloak >
                        @yield('content')
                    </div>
                </div>
            </div>
...
<script>
    window.Booking = <?php echo json_encode(array_merge(
        getTranslationsJs(), []
    )); ?>;
</script>
