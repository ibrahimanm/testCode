...
@section('content')
    ...
    <delegates-show inline-template :delegate='{!! isset($delegate) ? $delegate->toJson() : 'null' !!}'>
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    &nbsp;
                    &nbsp;
                    <h3 class="m-subheader__title m-subheader__title--separator">المندوبين</h3>
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{url('dashboard/delegates')}}" class="m-nav__link">
                                <span class="m-nav__link-text">المندوبين</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                            ...
                            <div class="m-card-profile">
                                ...
                                <div class="m-card-profile__pic">
                                    <div class="m-card-profile__pic-wrapper">
                                        ...
                                        <img v-if="delegate.personal_img"  :src="'https://delegate-api.applaab.com/'+delegate.personal_img" alt="" />
                                        ...
                                        <div class="m-widget13">
                                            ...
                                            <div class="m-widget13__item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                       <span class="m-widget13__text m-widget13__text-bolder">
													{{--@{{ delegate.id_img }}--}}
                                                           <img v-if="delegate.id_img" style="max-height: 100px;cursor: pointer;" :src="'https://delegate-api.applaab.com/'+delegate.id_img" @click="openImageModal(delegate.id_img)" :alt="delegate.id_img" class="img-thumbnail">
												       <span v-else>-</span>
												        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                       <span class="m-widget13__text m-widget13__text-bolder">
                                                        ...
                                                        <img v-if="delegate.car_licence_img" style="max-height: 100px; cursor: pointer" :src="'https://delegate-api.applaab.com/'+delegate.car_licence_img" @click="openImageModal(delegate.car_licence_img)" alt="..." class="img-thumbnail">
                                                            <span v-else>-</span>
                                            ...
                                            <div class="m-widget13__item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                       <span v-if="delegate.company" class="m-widget13__text m-widget13__text-bolder">
...
{{--                                            car style--}}
                                            <div class="m-widget13__item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                       <span v-if="delegate.style" class="m-widget13__text m-widget13__text-bolder">
													@{{ delegate.style.name }}
												        </span>
                                                        <span v-else>-</span>
                                                    </div>
...
{{--                                            --}}{{--car model--}}
                                            <div class="m-widget13__item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                       <span v-if="delegate.model" class="m-widget13__text m-widget13__text-bolder">
													@{{ delegate.model.name }}
												        </span>
                                                        <span v-else>-</span>
                                            ...
                                            <div class="m-widget13__item">
                                                ...
                                                <div class="row">
													...
													{{--@{{ delegate.vehicle_type }}--}}
                                                         ...
                                                         <img v-for="img in delegate.vehicle_images_array "  style="max-height: 100px; cursor: pointer" :src="'https://delegate-api.applaab.com/'+img" @click="openImageModal(img)" alt="..." class="img-thumbnail">
                                                           </span>
                                                           <span v-else>-</span>
